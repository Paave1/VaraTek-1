          ...
          <div className="header-right">
            ...
            <nav id="mainNav">
              <ul className="nav-links">
                ...
                <li><a href="/products" className="nav-link"><span className="en">Products</span><span className="fi hidden">Tuotteet</span></a></li>
          ...
          <div className="container">
            <div className="footer-content">
              <div className="footer-logo">
                <a href="/" className="footer-logo-container logo-link">
